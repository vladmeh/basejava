...
**Patch:**
 - [`Lesson05 Static initializer block and Collections`](https://github.com/vladmeh/basejava/blob/master/patch/Lesson05_Static_initializer_block_and_Collections.patch)
